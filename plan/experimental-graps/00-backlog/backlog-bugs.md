...
- **Status:** Done — fixed 2026-07-18. Drawer CSS/backdrop removed; 3-column flex on all devices with narrower breakpoint defaults (`--dir-w: 140px; --ai-w: 160px` ≤1024px; `100px/110px` ≤640px); `applyWidth()` guard + JS mobile init removed; resizers shown on mobile; min width 200px → 80px. Entity: [`07-bugs-and-fixes/bug-0008-mobile-panels-cover-workspace.md`](../07-bugs-and-fixes/bug-0008-mobile-panels-cover-workspace.md).

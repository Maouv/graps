...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0001, FEAT-0008]
related: []
---

# dir-panel explorer

> **Summary Block:** Provide the left explorer panel for deterministic structural navigation. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Folder click only expands or collapses.
- [ ] File click expands functions and opens source.
- [ ] Module click expands contents and opens module overview.
- [ ] Keyboard tree navigation exposes correct ARIA state.
...
- dir-panel explorer may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

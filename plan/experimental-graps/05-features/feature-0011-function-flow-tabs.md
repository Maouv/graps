...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0003, FEAT-0009, FEAT-0019]
related: []
---

# Function flow tabs

> **Summary Block:** Open truthful structural flow views when a function is selected. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Function click opens flow, not source.
- [ ] MVP direct-call view is named `call_sequence`.
- [ ] Resolved, partial, and unresolved confidence stays visible.
- [ ] Branches are never flattened into a false linear sequence.
...
- Function flow tabs may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

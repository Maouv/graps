...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0001, FEAT-0005]
related: []
---

# Resizable left and right panels

> **Summary Block:** Allow safe resizing and restoration of both side panels. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Widths stay inside documented minimum and maximum bounds.
- [ ] Reopening restores the last valid width.
- [ ] Invalid persisted widths fall back safely.
...
- Resizable left and right panels may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

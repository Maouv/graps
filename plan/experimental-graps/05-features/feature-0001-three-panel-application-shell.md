...
> **Summary Block:** Provide the canonical `dir-panel | workspace | ai-panel` shell without decorative filler. Implemented as part of TASK-0003. See task file for implementation evidence and smoke test results.

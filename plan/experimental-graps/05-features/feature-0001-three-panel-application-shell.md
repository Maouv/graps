...
> **Summary Block:** Provide the canonical `dir-panel | workspace | ai-panel` shell without decorative filler. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Desktop renders the three named regions in the required order.
- [ ] Reserved empty regions remain literally empty.
- [ ] Closing a side panel expands workspace without renaming panel identities.
...
- Three-panel application shell may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

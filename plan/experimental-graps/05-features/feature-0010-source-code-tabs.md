...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0003, FEAT-0009, FEAT-0017]
related: []
---

# Source-code tabs

> **Summary Block:** Open secure source views for files and focused functions. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] File click opens or deduplicates a source tab.
- [ ] Source responses never expose absolute scan-root paths.
- [ ] Traversal outside scan root is rejected.
- [ ] Source view can link to available flows.
...
- Source-code tabs may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

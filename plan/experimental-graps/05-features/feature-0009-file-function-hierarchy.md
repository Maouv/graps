...
> **Summary Block:** Expose files and their parsed functions beneath the structural tree. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.

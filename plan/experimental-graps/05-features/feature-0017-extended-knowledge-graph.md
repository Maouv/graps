...
# Extended structural knowledge graph

> **Summary Block:** Model folders, packages, modules, files, classes, functions, routes, calls, and uncertainty. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
- Extended structural knowledge graph may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

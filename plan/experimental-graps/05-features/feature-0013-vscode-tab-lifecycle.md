...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0003, FEAT-0010, FEAT-0011, FEAT-0012]
related: []
---

# VS Code-like tab lifecycle

> **Summary Block:** Provide preview, pin, deduplication, close, overflow, and safe session restoration. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Single click may reuse a safe preview tab.
- [ ] Double-click or pin makes a tab persistent.
- [ ] Tabs deduplicate by stable entity or flow ID.
- [ ] Restored tabs for deleted entities fail safely.
...
- VS Code-like tab lifecycle may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

...
> **Summary Block:** Provide a minimal AI panel containing status and an input bar for chat and scan commands. Implemented as part of TASK-0003. See task file for implementation evidence and smoke test results.

...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0001, FEAT-0014, FEAT-0019]
related: []
---

# ai-panel with input bar

> **Summary Block:** Provide a minimal AI panel containing status and an input bar for chat and scan commands. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Panel shows structural/enrichment status without blocking browsing.
- [ ] Input accepts normal chat and documented `/scan` commands.
- [ ] Missing provider never opens a blocking modal.
...
- ai-panel with input bar may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

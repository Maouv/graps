...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0003, FEAT-0008, FEAT-0018]
related: []
---

# Module overview tabs

> **Summary Block:** Open structural module summaries with optional validated semantic metadata. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Overview shows path, boundary, members, routes, dependencies, and diagnostics.
- [ ] AI name/responsibility/capabilities are visibly optional.
- [ ] Structural fallback remains complete when enrichment is absent.
...
- Module overview tabs may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

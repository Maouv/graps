...
> **Summary Block:** Infer deterministic module boundaries from language packages and folders, with optional semantic grouping. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
- Structural module resolution may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

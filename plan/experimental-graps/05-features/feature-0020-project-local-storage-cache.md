...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0016, FEAT-0017]
related: []
---

# Project-local incremental storage and cache

> **Summary Block:** Persist versioned graph, architecture overlay, settings, and incremental cache under `{scan_root}/.graps`. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
- Project-local incremental storage and cache may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

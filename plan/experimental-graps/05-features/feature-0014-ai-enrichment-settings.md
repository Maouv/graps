...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0019, FEAT-0020]
related: []
---

# AI Enrichment settings

> **Summary Block:** Expose AI Enrichment as a default-ON semantic setting separate from structural scanning. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Toggling AI never disables structural scan.
- [ ] No-key and provider failure use technical labels.
- [ ] Settings accept only whitelisted fields.
- [ ] User overrides affect semantic overlay, not graph truth.
...
- AI Enrichment settings may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

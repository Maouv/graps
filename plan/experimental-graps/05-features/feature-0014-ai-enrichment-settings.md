...
> **Summary Block:** Expose AI Enrichment as a default-ON semantic setting separate from structural scanning. Implemented as part of TASK-0003. See task file for implementation evidence and smoke test results.

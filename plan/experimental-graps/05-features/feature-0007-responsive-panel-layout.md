...
created: 2026-07-14
updated: 2026-07-14
depends_on: [FEAT-0001, FEAT-0005, FEAT-0006]
related: []
---

# Responsive panel layout

> **Summary Block:** Preserve the desktop mental model on tablet and phone through drawers and overlays. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Tablet and phone never squeeze three simultaneous columns.
- [ ] Touch targets are at least 44px.
- [ ] Phone uses one active side overlay at a time.
- [ ] Rotation and viewport changes recover valid panel state.
...
- Responsive panel layout may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

...
> **Summary Block:** Provide the central read-only workspace that hosts source, flow, and module tabs. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
### Acceptance Criteria
- [ ] Workspace remains primary when side panels close.
- [ ] Only source, flow, and module views are rendered.
- [ ] No fake analytics or placeholder product UI appears.
...
- workspace primary area may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.

...
# Automatic structural project scan

> **Summary Block:** Always produce deterministic project structure without requiring AI. This entity is planning-only and cannot enter implementation before its dependencies and Definition of Ready are satisfied.
...
- Automatic structural project scan may violate its contract if dependent structural IDs, state, or fallback behavior is incomplete.
